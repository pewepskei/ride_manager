...
SECRET_KEY = 'django-insecure-9d#0azec%3zy#a!*-vclr5hglypmf@guoqtlw^tba6bolow^5v'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',   # since it's running in WSL
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rides.authentication.SimpleHeaderAuthentication',
    ],
